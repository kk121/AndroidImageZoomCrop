 ...
 */
public class CircularCropOverlayView extends View implements IGetImageBounds {
    ...
    private int DEFAULT_MAX_WIDTH = 500;
    ...
    public CircularCropOverlayView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
...
//        paint.setAlpha(0);
    ...
    private void init(Context context) {
        ...
        int w = dpToPx(context,200);
        int leftMargin = (deviceWidth - w) / 2;
        cropWidth = deviceWidth - 2 * mMarginSide;
